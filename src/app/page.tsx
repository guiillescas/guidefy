          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg lg:text-xl mb-8 max-w-lg">
                Stop struggling with setlist organization. guidefy helps music directors create and modify song
                sequences in seconds, so you can focus on what matters:{' '}
                <span className="font-semibold">making great music</span>.
              </p>
              ...
              <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 text-gray-400 justify-center sm:justify-start">
            ...
            {[
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <h3
                    className={`font-space text-xl font-bold mb-2 bg-clip-text text-transparent group-hover:opacity-80 transition-opacity bg-gradient-to-r ${benefit.gradient}`}
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r opacity-0 group-hover:opacity-5 transition-opacity rounded-2xl ${benefit.gradient}`}
                  style={{ backgroundImage: `linear-gradient(to right, var(--tw-gradient-stops))` }}
                />
              </motion.div>
            ))}
      ...
      <section id="workflow" className="py-24 relative overflow-hidden">
        <div className="container px-4 mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Stop wasting time with complicated setlist management. guidefy simplifies your workflow so you can focus
              on leading your band.
            </p>
          </motion.div>
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm">Empowering music directors with intelligent setlist management.</p>
            </div>

            <div>
              <h4 className="font-space text-sm font-semibold text-gray-300 mb-4">Product</h4>
              <ul className="space-y-2">
                {['Features', 'Pricing', 'Sign Up', 'Sign In'].map(item => (
                  <li key={item}>
                    <button
            ...
            <div>
              <h4 className="font-space text-sm font-semibold text-gray-300 mb-4">Legal</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="font-space text-sm font-semibold text-gray-300 mb-4">Connect</h4>
          ...
          <div className="pt-8 mt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-gray-400">© {new Date().getFullYear()} guidefy. All rights reserved.</p>
